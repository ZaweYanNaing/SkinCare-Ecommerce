...
import glowLogo from '../../assets/glow-logo.svg';
      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-100 px-4">
        <div className="flex w-full max-w-4xl flex-col overflow-hidden rounded-2xl bg-white shadow-xl md:flex-row">
          ...
          <div className="flex flex-col justify-center bg-gray-50 p-8 md:w-1/2">
            <div className="mb-8">
              <img src={glowLogo} alt="GLOW Logo" className="h-12" />
            </div>
            <h1 className="mb-4 text-4xl font-bold text-gray-800">Welcome Back!</h1>
            <div className="mb-6 w-24 border-b border-gray-300"></div>
            <p className="mb-6 text-gray-600">Don't have an account yet?</p>
            <Link to="/auth/signup">
              <button className="w-fit rounded-full border border-green-500 px-6 py-2 text-green-500 transition hover:bg-green-50">Sign Up</button>
            </Link>
          </div>
          {/* Right side */}
          <div className="rounded-r-2xl bg-white p-8 md:w-1/2">
            <h2 className="mb-6 text-2xl font-semibold text-green-600">Sign In</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input type="checkbox" id="remember" className="h-4 w-4 rounded border-gray-300 text-green-500 focus:ring-green-400" />

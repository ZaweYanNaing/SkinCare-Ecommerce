import { LogIn, Minus, Plus, Tickets, Trash2, Menu, X } from 'lucide-react';
...
export default function navbar() {
  ...
  return (
    <>
      <div
        className={`top-0 flex h-16 lg:h-20 w-full items-center justify-between px-4 lg:px-10 ${showNavBar ? 'fixed right-0 left-0 z-30 w-full justify-center bg-white/95 backdrop-blur-sm' : 'shadow-lg'}`}
      >
        {/* Logo */}
        <img className={`w-16 lg:w-20 ${showNavBar ? 'hidden lg:block' : ''}`} src={logo} alt="Skincare Logo" />

        {/* Desktop Navigation */}
        <div
          className={`hidden lg:flex gap-x-14 font-semibold tracking-wider ${showNavBar ? 'mt-10 rounded-[35px] border-[#E5F5F0] bg-[#FCFCFC]/[2%] px-[49px] py-[21px] shadow-[5px_10px_24px_rgba(140,136,136,0.25)] backdrop-blur-[10px]' : 'ms-[273px]'}`}
        >
          <Link to="/" className="hover:text-[#039963] transition-colors">Home</Link>
          <Link to="/product" className="hover:text-[#039963] transition-colors">Product</Link>
          <Link to="/wishList" className="hover:text-[#039963] transition-colors">WishList</Link>
          <Link to="/consult" className="hover:text-[#039963] transition-colors">Consult</Link>
        </div>

        {/* Mobile Menu Button */}
        <button
          className={`lg:hidden p-2 ${showNavBar ? 'hidden' : ''}`}
          onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
        >
          {mobileMenuOpen ? <X className="h-6 w-6" /> : <Menu className="h-6 w-6" />}
        </button>

        {/* Desktop Search and Profile, Shopping Cart */}
        <div className={`hidden lg:flex gap-x-6 ${showNavBar ? 'hidden' : ''}`}>
          <div className="flex w-full max-w-[217.85px] items-center gap-x-3 rounded-[44px] bg-[#E5F5F0] px-5 py-2.5">
            ...
            <input value={search} onChange={handleSearchChange} type="text" placeholder="Search..." className="flex-1 bg-transparent outline-0 text-sm" />
          </div>
            ...
            <div className="flex gap-x-6">
              ...
              <Sheet>
                <SheetTrigger className="w-full rounded-[8px] bg-[#E5F5F0]">
                  <div className="relative w-full flex items-center justify-center rounded-[8px] bg-[#E5F5F0] px-3 py-2 cursor-pointer">
          ...
          {!user.email && (
            <div className="flex">
              <Popover>
                <PopoverTrigger asChild>
                  <div className="flex cursor-pointer items-center justify-center rounded-[8px] bg-[#E5F5F0] px-3 py-2">
        ...
        {/* Mobile Actions - Only show when not in showNavBar mode */}
        <div className={`flex lg:hidden gap-x-3 ${showNavBar ? 'hidden' : ''}`}>
          {/* Mobile Search */}
          <div className="flex items-center gap-x-2 rounded-[44px] bg-[#E5F5F0] px-3 py-2 max-w-[150px]">
          ...
          {!!user.email && (
            <Sheet>
              <SheetTrigger className="rounded-[8px] bg-[#E5F5F0]">
                <div className="relative flex items-center justify-center rounded-[8px] bg-[#E5F5F0] px-3 py-2 cursor-pointer">
              ...
              <SheetContent className="w-full sm:w-[400px]">
                ...
                {/* Cart content would be the same as desktop version */}
              </SheetContent>
            </Sheet>
          )}
          ...
          {!!user.email ? (
            <Popover>
              ...
              <PopoverContent className="w-30">
                <div className="flex flex-col items-center justify-between gap-y-3">
                  <Link to="/profile">
                    <p className="cursor-pointer text-xs">Profile</p>
                  </Link>
                  <div className="cursor-pointer w-full flex justify-center">
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
            ...
            <Popover>
              ...
              <PopoverContent className="w-30">
                <div className="flex flex-col items-center justify-center gap-y-5">
                  ...
                  <Link to="/auth/signup">
                    <p className="cursor-pointer text-sm">Register</p>
                  </Link>
                </div>
              </PopoverContent>
            </Popover>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-50 bg-black bg-opacity-50" onClick={() => setMobileMenuOpen(false)}>
          <div className="fixed top-0 left-0 w-64 h-full bg-white shadow-lg" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between p-4 border-b">
              <img className="w-16" src={logo} alt="Skincare Logo" />
            ...
            <nav className="p-4">
              <div className="flex flex-col space-y-4">
                <Link 
                  to="/" 
                  className="text-lg font-medium hover:text-[#039963] transition-colors py-2"
              ...
              <div className="mt-8 pt-4 border-t">
                {!!user.email ? (
                  <div className="space-y-4">
                    <Link 
                      to="/profile" 
                      className="block text-lg font-medium hover:text-[#039963] transition-colors py-2"
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      Profile
                    </Link>
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <button className="text-lg font-medium text-red-600 hover:text-red-700 transition-colors py-2">
                          Logout
                        </button>
                      </AlertDialogTrigger>
                      <AlertDialogContent className="py-10">
